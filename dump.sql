...
--
-- Host: 127.0.0.1    Database: hry_db
-- ------------------------------------------------------
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `users` (
  `column_name` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
(1,'admin','$2y$10$GRA8D27bvZZw8b85CAwRee9NH5nj4CQA6PDFMc90pN9Wi4VAWq3yq');
...
-- Dump completed on 2022-11-22  6:48:29
